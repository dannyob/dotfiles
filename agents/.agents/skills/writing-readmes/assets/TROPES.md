> **Bundled snapshot.** A point-in-time copy of TROPES.md, included so the
> writing-readmes skill is self-contained. For the latest version, check
> <https://tropes.fyi/> (by ossama.is) and refresh this file from there.
