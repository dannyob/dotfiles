(custom-set-variables
 ...
 '(package-selected-packages '(slime aggressive-indent vterm debbugs))
   ...
   '((eval add-hook 'after-save-hook
      (lambda nil
        (when
          ...
          (org-export-to-file 'html
              "~/Public/dannyob.eth/now/narrative-arc.html"
            f)))
      nil 'local)
     (org-agenda-files . ".")
     ...
     (eval let
      ...
      (when root-dir-unexpanded
        (let*
            ((root-dir (file-local-name (expand-file-name root-dir-unexpanded)))
     ...
     (eval setq scheme-font-lock-keywords-2
      (cons '("(\\(define-json-mapping\\)" (1 font-lock-keyword-face))
            scheme-font-lock-keywords-2))
     (org-src-preserve-indentation) (eval require 'ox-texinfo+ nil t)
     (eval require 'ol-info)
     (elisp-lint-indent-specs (describe . 1) (it . 1) (org-element-map . defun)
      (org-roam-dolist-with-progress . 2) (org-roam-with-temp-buffer . 1)
      (org-with-point-at . 1) (magit-insert-section . defun)
      (magit-section-case . 0) (org-roam-with-file . 2))
                                          ...
                                          (list
                                           ...
                                           (purecopy
                                            (concat "^\\s-*("
                                                    ...
                                                    "\\)"))
                                           2)))))
      (enhance-imenu-lisp "bookmarklet-command" "class" "command" "ffi-method"
                          "function" "mode" "parenscript" "user-class"))
                                          ...
                                          (list
                                           ...
                                           (purecopy
                                            (concat "^\\s-*("
                                                    ...
                                                    "\\)"))
                                           2)))))
      (enhance-imenu-lisp "bookmarklet-command" "class" "command" "function"
                          "mode" "parenscript" "user-class"))
     (no-ytbyte-compile . t)))
 '(send-mail-function 'mailclient-send-it)
 '(tracking-shorten-modes nil)
 '(warning-suppress-types
   '((org-element-cache) ((sly warning)) ((sly warning)) (nrepl-connected-hook))))
